...
CREATE TABLE `analises` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKediamxial8dv6vvq93ncr47ie` (`id_filme`),
  CONSTRAINT `FKediamxial8dv6vvq93ncr47ie` FOREIGN KEY (`id_filme`) REFERENCES `filmes` (`id`)
...
INSERT INTO `analises` VALUES (4,'O melhor filme de todos os tempos!',1);
...
-- Dump completed on 2023-10-07 15:13:25
